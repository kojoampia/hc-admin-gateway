        ...
        return new ContextCustomizer() {
            ...
            public void customizeContext(ConfigurableApplicationContext context, MergedContextConfiguration mergedConfig) {
                ...
                if (null != mongoAnnotation) {
                    ...
                    String mongoUri = mongoDbBean.getMongoDBContainer().getReplicaSetUrl();
                    testValues = testValues.and("spring.data.mongodb.uri=" + mongoUri);
                    testValues = testValues.and("spring.mongodb.uri=" + mongoUri);
                }
